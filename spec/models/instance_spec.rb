...
describe Instance do
  ...
  describe 'has_many subrels' do
    before do
      ...
      @relation = FactoryGirl.create(:relation, :relsub_id => @instance.id, :relsub_type => @instance.class.to_s, :relobj => @span, :project => @project)
      FactoryGirl.create(:relation, :relsub_id => 20, :relsub_type => @instance.class.to_s, :relobj => @span, :project => @project)
    end
  ...
  describe 'has_many objrels' do
    before do
      ...
      @span = FactoryGirl.create(:span, :project => @project, :doc => FactoryGirl.create(:doc))
      @instance = FactoryGirl.create(:instance, :project => @project, :obj => @span)
      @relation = FactoryGirl.create(:relation, :relsub_id => @span.id, :relsub_type => @span.class.to_s, :relobj => @instance, :relobj_type => @instance.class.to_s, :project => @project)
      FactoryGirl.create(:relation, :relsub_id => @span.id, :relsub_type => @span.class.to_s, :relobj => @span, :relobj_type => @span.class.to_s, :project => @project)
    end
