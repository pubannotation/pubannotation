    ...
    class << self
      def call(project, annotations_collection)
        ActiveRecord::Base.transaction do
          ...
          b_stat, b_stat_all, imported_blocks = import_blocks(project, annotations_collection)
          r_stat, r_stat_all, imported_relations = import_relations(project, annotations_collection, imported_denotations, imported_blocks)

          import_attributes(project, annotations_collection, imported_denotations, imported_blocks, imported_relations)
          ...
          update_project(project, d_stat_all, b_stat_all, r_stat_all)
        end
      end
