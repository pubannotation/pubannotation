class Project < ActiveRecord::Base
  ...
  def store_annotations_collection(annotations_collection, options)
    ...
    annotations_for_doc_collection, messages = align_text_in_ractor annotations_for_doc_collection, options, messages
  ...
  def align_text_in_ractor(annotations_for_doc_collection, options, messages)
    pipe = Ractor.new do
      loop do
    ...
    [annotations_for_doc_collection, messages]
  end
