class ProjectsController < ApplicationController
	...
	def uptodate_docs
		begin
			...
			flash[:notice] = "The task, '#{active_job.job_name(project.name)}', is created."
	...
	def create_annotations_rdf
		message = begin
			...
			"The task, '#{active_job.job_name(project.name)}', is created."
		rescue => e
			e.message
		end
	...
	def delete_all_docs
		begin
			...
			message = if project.has_doc?
				...
				"The task, '#{active_job.job_name(nil)}', is created."
			else
	...
	def destroy_all_annotations
		begin
			...
			message = "The task, '#{active_job.job_name(nil)}', is created."
